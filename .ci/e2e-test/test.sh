...
cd $(dirname $0)
curl --location https://dl.k8s.io/v1.18.1/kubernetes-test-linux-arm64.tar.gz | tar --strip-components=3 -zxf - kubernetes/test/bin/e2e.test kubernetes/test/bin/ginkgo
